...
RegExp("^(https?:\\/\\/(.+?\\.)?(salesforce|salesforcescrt|salesforceliveagent)\\.com(\\/[A-Za-z0-9\\-\\._~:\\/\\?#\[\\]@!$&'\\(\\)\*\\+,;\\=]*)?)");
...
<h1>Pre-Chat Form</h1>
<!-- Form that gathers information from the chat visitor and sets the values to Chat Custom
Details used later in the example -->
